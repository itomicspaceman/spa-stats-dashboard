...
Copy-Item "docs\wordpress-plugin\PLUGIN-README.md" -Destination "temp\$PLUGIN_NAME\README.md"
...
Write-Host "   - Dashboard: [squash_court_stats dashboard='world']"
Write-Host "   - Report: [squash_court_stats report='graveyard']"
Write-Host "3. Publish!"
Write-Host ""
Write-Host "Optional parameters:" -ForegroundColor Gray
Write-Host "  [squash_court_stats dashboard='world' height='2000px']"
Write-Host "  [squash_court_stats report='graveyard' class='my-custom-class']"
